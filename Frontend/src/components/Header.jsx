    ...
    <div className='flex flex-col md:flex-row flex-wrap bg-[#5f6FFF] rounded-lg px-6 md:px-10 lg:px-20'>
      ...
      <div className='md:w-1/2 flex flex-col  items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
        ...
        <div className='flex flex-col md:flex-row items-center gap-3 text-white text-sm font-light'>
          <img className='w-[30px]' src={assets.gr} alt="" />
        ...
        <a href="#speciality" className='flex items-center gap-2 bg-white px-8 py-3 rounded-full text-gray-600 text-sm m-auto md-m-0 hover:scale-105 transition-all duration-300'>
          Book appointment <b className='w-3'><MdOutlineArrowRightAlt /></b>
        </a>
      </div>

      {/* --- Right Side ---- */}
      <div className='md:w-1/2 relative'>
  <img className='w-full md:absolute bottom-0 h-auto rounded-lg' src={assets.gr1}  />
      </div>
    </div>
  )
}
